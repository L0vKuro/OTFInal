...
function LiveButton() {
  ...
  return (
    <Link href="/creators"
      className="fixed bottom-6 right-6 z-50 flex items-center gap-3 bg-[#0D0D0D] border border-[#E8191A]/60 px-12 py-5 shadow-[0_0_30px_rgba(232,25,26,0.5)] hover:shadow-[0_0_50px_rgba(232,25,26,0.8)] transition-all group"
