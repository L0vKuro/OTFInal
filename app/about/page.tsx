...
{ name: 'Lazur', role: 'CEO / Founder', bio: 'Visionary behind Overtake Sector. Building the org from the ground up with passion and purpose.', twitter: 'wydlazur' },
  ...
  { name: 'Spot', role: 'President of Esports', bio: 'Leads Overtake’s competitive division and drives the growth and success of its esports teams.', twitter: 'SpotJr25' },
  ...
  { name: 'Frostii', role: 'Director of Content', bio: 'Leads Overtake’s content strategy, creative direction, and efforts to grow the organization’s presence.', twitter: 'WhosFrostii' },
  { name: 'Mandii', role: 'Content Manager', bio: 'Coordinates Overtake’s content, supports creators, and helps keep the organization’s media active and engaging.', twitter: '@xoMandiii' },
...
const quotes = [
  ...
  { name: 'Spot', role: 'President of Esports', quote: 'Champions are made when nobody is watching.' },
  ...
  { name: 'Frostii', role: 'Director of Content', quote: 'Creativity is intelligence having fun.' },
  { name: 'Mandii', role: 'Content Manager', quote: 'Content is not just what you create; it is the story you leave behind.' },
