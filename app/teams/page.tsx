    ...
    <div className="relative min-h-screen">
      ...
      <div className="sticky top-16 z-30 bg-[#0D0D0D]/95 backdrop-blur border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center gap-1 overflow-x-auto py-0" style={{ scrollbarWidth: 'none' }}>
            {teams.filter(t => t.id !== 'fortnite').map((team) => {
              const isActive = activeId === team.id
              return (
                <button key={team.id} onClick={() => scrollTo(team.id)}
                  className="flex-shrink-0 flex items-center gap-2 px-4 py-3.5 text-xs font-black tracking-widest uppercase transition-all border-b-2 whitespace-nowrap"
                  style={{
                    fontFamily: 'Barlow Condensed, sans-serif',
                    color: isActive ? team.color : 'rgba(242,242,242,0.3)',
                    borderBottomColor: isActive ? team.color : 'transparent',
                    background: isActive ? `${team.color}08` : 'transparent',
                  }}>
                  {GAME_SHORT[team.game] || team.game}
                </button>
              )
            })}
          </div>
      ...
      <div className="space-y-0">
        {teams.map((team: any) => {
          ...
          return (
            <div key={team.id} id={team.id} className="scroll-mt-28 relative overflow-hidden">
              {/* Colored background glow per team */}
              <div className="absolute inset-0 pointer-events-none"
                style={{ background: `linear-gradient(135deg, ${team.color}06 0%, transparent 60%)` }} />
              ...
              <div className="relative max-w-7xl mx-auto px-6 pt-16 pb-20">
                ...
                <div className="mb-10">
                  ...
                  {/* Colored divider */}
                  <div className="h-px w-full mt-6" style={{ background: `linear-gradient(90deg, ${team.color}, transparent)` }} />
                </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="relative overflow-hidden bg-[#0D0D0D]" style={{ height: '280px' }}>
                          ...
                          <div className="absolute inset-0" style={{ background: `linear-gradient(to top, #141414 15%, transparent 60%)` }} />
              ...
              {/* Section divider */}
              <div className="h-px mx-6" style={{ background: 'linear-gradient(90deg, transparent, rgba(255,255,255,0.06), transparent)' }} />
            </div>
          )
        })}
      </div>
